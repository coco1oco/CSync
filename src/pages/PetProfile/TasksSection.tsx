            ...
            {activeTasks.map((task) => (
              ...
              >
                ...
                <div className="flex flex-wrap gap-2 items-center text-sm mb-2">
                  {getUrgencyBadge(
                    task.urgency,
                    task.requires_immediate_attention
                  )}
                  <span
                    className={`text-xs px-2 py-1 rounded-full border font-semibold cursor-pointer ${
        ...
        <div>
          ...
          <div className="space-y-2">
            {completedTasks.map((task) => (
              <div
                key={task.id}
                className="bg-gray-50 p-4 rounded-lg border border-gray-200 opacity-60"
              >
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              onChange={(e) =>
                setFormData({
                  ...formData,
                  requires_immediate_attention: e.target.checked,
                })
              }
