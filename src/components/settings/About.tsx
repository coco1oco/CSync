import { Globe, InstagramIcon, FacebookIcon, Mail, ExternalLink, Heart, Shield, FileText } from "lucide-react";
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          >
            ...
            <ExternalLink size={14} className="ml-auto text-gray-300 group-hover:text-black" />
          </a>
          ...
          >
            ...
            <div className="text-sm">
              ...
              <span className="text-gray-500 text-xs">@youthforanimals.cvsumain</span>
            </div>
          ...
          >
            ...
            <div className="text-sm">
              ...
              <span className="text-gray-500 text-xs">Youth For Animals - CvSU Main Campus</span>
            </div>
          ...
          >
            ...
            <div className="text-sm">
              ...
              <span className="text-gray-500 text-xs">yfa.main2025@gmail.com</span>
            </div>
          </a>
